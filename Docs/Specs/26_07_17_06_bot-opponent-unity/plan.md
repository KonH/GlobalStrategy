...
- **Planning discipline** — this plan itself is the required artifact; spec 26_07_17_06_bot-opponent-unity was approved before this plan was written, per `.claude/commands/plan.md`'s ordering.
- **Specification discipline** — satisfied; this is feature work and it went through `/specify` already (`Docs/Specs/26_07_17_06_bot-opponent-unity/spec.md`).
- **File organisation** — this plan lives at `Docs/Specs/26_07_17_06_bot-opponent-unity/plan.md`, alongside its spec, retaining its commit-derived dated identifier.
