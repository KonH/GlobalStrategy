...
- **Group 5 — live session:**
  ...
  - Addressing: `Assets/Scripts/Unity/E2E/E2EElementResolver.cs` — name → visible label → indexed `ListView` row; `RuntimePanelUtils.ScreenToPanel` round-trip check; failure message lists present names/labels.
