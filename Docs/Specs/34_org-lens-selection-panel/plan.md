...
| Spec before plan | Spec exists at `Docs/Specs/32_org-lens-selection-panel/spec.md`. |
| File organisation | Plan saved to `Docs/Specs/32_org-lens-selection-panel/plan.md` matching the existing spec index. |
