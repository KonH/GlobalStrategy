...
# its way past --stall-limit forever (see the codex_ralph.py incident on GlobalStrategy#41,
# where 12 verification-only bundleVersion-bump commits masked a fully stalled loop). A genuine
# progress commit always touches at least one other file, so it still counts as meaningful.
