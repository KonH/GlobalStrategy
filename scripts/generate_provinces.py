...
Output:
    .tmp/provinces_intermediate.geojson — FeatureCollection with properties:
        ...
        population (post-simplify area x per-country region density, see REGION_DENSITY_RANGES)
...
# Approximate 1880-era relative population-density bands per region, in people/km^2.
# Not researched real data — plausible ordering only (denser South/East Asia and
# Western Europe, sparser Northern Europe/Central Asia/interior deserts). Used to
# sample a per-province density (see try_option_c call sites in run()) that gets
# multiplied by each province's final (post-simplify) area to fill in "population".
REGION_DENSITY_RANGES = {
    "WesternEurope": (60.0, 180.0),
    "NorthernEurope": (5.0, 25.0),
    "EasternEurope": (20.0, 70.0),
    "SouthAsia": (80.0, 250.0),
    "EastAsia": (50.0, 200.0),
    "SoutheastAsia": (30.0, 120.0),
    "MiddleEast": (3.0, 25.0),
    "CentralAsia": (0.5, 8.0),
    "NorthAfrica": (3.0, 25.0),
    "SubSaharanAfrica": (3.0, 30.0),
    "NorthAmerica": (1.0, 15.0),
    "CentralAmerica": (8.0, 40.0),
    "SouthAmerica": (1.0, 15.0),
    "Oceania": (1.0, 20.0),
    "Default": (5.0, 30.0),
}

# countryId -> region key (see REGION_DENSITY_RANGES). Every country in
# country_config.json is covered; countries not listed here fall back to "Default".
COUNTRY_REGION = {
