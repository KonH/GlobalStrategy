...
- **GitHub issue → spec automation:** `.claude/rules/github_issue_automation.md` — Routine that turns owner-authored issues into spec PRs via `.claude/commands/handle-feature-issue.md`
