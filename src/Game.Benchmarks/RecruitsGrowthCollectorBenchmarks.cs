...
namespace GS.Game.Benchmarks {
	[MemoryDiagnoser]
	public class RecruitsGrowthCollectorBenchmarks {
		World _world = null!;
		...
		public void Setup() {
			...
			_collector = fixture.CollectorRegistry.Resolve(RecruitsGrowthCollector.Id);
			_countryId = fixture.FirstCountryId;
			_currentValue = resources.GetValue(_world, _countryId, ResourceDefinitions.Recruits);
		}
